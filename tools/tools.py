...
from tools.desktop_pet import (
    DESKTOP_PET_TOOL_SCHEMAS,
    DESKTOP_PET_TOOL_FUNCTIONS,
    DESKTOP_PET_RISKY_TOOLS,
)
...
from tools.map_hud import (
    MAP_HUD_TOOL_SCHEMAS,
    MAP_HUD_TOOL_FUNCTIONS,
    MAP_HUD_RISKY_TOOLS,
)
...
TOOL_SCHEMAS += MAP_HUD_TOOL_SCHEMAS
TOOL_SCHEMAS += WEATHER_TOOL_SCHEMAS
TOOL_SCHEMAS += DESKTOP_PET_TOOL_SCHEMAS
...
TOOL_FUNCTIONS.update(MAP_HUD_TOOL_FUNCTIONS)
TOOL_FUNCTIONS.update(WEATHER_TOOL_FUNCTIONS)
TOOL_FUNCTIONS.update(DESKTOP_PET_TOOL_FUNCTIONS)
...
RISKY_TOOLS |= MAP_HUD_RISKY_TOOLS
RISKY_TOOLS |= WEATHER_RISKY_TOOLS
RISKY_TOOLS |= DESKTOP_PET_RISKY_TOOLS
